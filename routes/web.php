...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('events/{event}/code-access/{codeAccess}/edit', [EventCodeAccessController::class, 'edit'])->name('events.code-access.edit');
    Route::put('events/{event}/code-access/{codeAccess}', [EventCodeAccessController::class, 'update'])->name('events.code-access.update');
    Route::delete('events/{event}/code-access/{codeAccess}', [EventCodeAccessController::class, 'destroy'])->name('events.code-access.destroy');
    Route::get('events/{event}/checkins', [EventCheckinController::class, 'index'])->name('events.checkins.index');
    Route::get('events/{event}/checkins/create', [EventCheckinController::class, 'create'])->name('events.checkins.create');
    Route::post('events/{event}/checkins', [EventCheckinController::class, 'store'])->name('events.checkins.store');
    Route::get('events/{event}/checkins/{checkin}/edit', [EventCheckinController::class, 'edit'])->name('events.checkins.edit');
    ...
    Route::get('events/{event}/live-result-categories/create', [LiveResultCategoryController::class, 'create'])->name('events.live-result-categories.create');
    ...
    Route::get('events/{event}/live-result-categories/{liveResultCategory}/edit', [LiveResultCategoryController::class, 'edit'])->name('events.live-result-categories.edit');
