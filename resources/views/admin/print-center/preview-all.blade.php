...
<head>
    ...
    <title>Print Preview - Semua Kategori Final - {{ $event->name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        @media print {
            ...
            /* Category section should try to avoid breaking */
            .category-section {
                page-break-inside: avoid;
            }
...
<body>
    ...
    @foreach($categoriesData as $categoryIndex => $categoryData)
        ...
        <!-- Print Header (appears on every category) -->
        ...
        <div class="category-section">
            @if($sheetData && isset($sheetData['groups']) && count($sheetData['groups']) > 0)
                <!-- Keterangan (only on first group of each category) -->
                    ...
                    <div class="group-container">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr>
                                        <td colspan="{{ 2 + ($sheetData['is_qualifikasi'] ?? false ? 1 : 0) + 2 }}" style="text-align: center; padding: 20px;">
                                            Tidak ada data
                                        </td>
                                    </tr>
                                @endif
            ...
            @else
                <div style="text-align: center; padding: 20px;">
                    <p>Tidak ada data yang tersedia untuk kategori ini.</p>
                </div>
            @endif
        </div>
    @endforeach
